	...
	render() {
		...
		return (
            <div className="container">
                ...
                <p>Inspirado en <a target="_blank" href="http://ketodietapp.com/Blog/page/KetoDiet-Buddy">KetoDiet Calculator</a> </p>
            ...
            <div className="">
                ...
                <form onsubmit="return false;">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="col">
                                    <InputFormNumberField fieldId="age" title="Edad" value={this.props.params.age} updateValue={this.updateAge.bind(this)} />
                                    </div>
                                    <div className="col">
                                    <InputFormWeightField fieldId="metric" libra={this.props.params.lbs} kilos={this.props.params.kgs}  updateValue={this.updateWeightToggle.bind(this)} />
                                {(this.props.params.kgs) &&
                                <InputFormNumberField fieldId="weight" title="Peso (Kilos)" value={this.props.params.weight} updateValue={this.updateWeight.bind(this)} />}
                                {(this.props.params.lbs) && 
                                <InputFormNumberField fieldId="weightlb" title="Peso (Libras)" value={this.props.params.weightlb} updateValue={this.updateWeightlb.bind(this)} />}
                                    </div>
                                </div>
                                ...
                                <InputFormNumberField fieldId="bodyfat" title="Grasa Corporal (%)" value={this.props.params.bodyfat} updateValue={this.updateBodyfat.bind(this)} />
                                <InputFormHeightField fieldId="metric2" cmsToggle={this.props.params.cmsToggle} inchesToggle={this.props.params.inchesToggle}  updateValue={this.updateHeightToggle.bind(this)} />
                                {(this.props.params.inchesToggle) && <InputFormNumberField fieldId="feet" title="Altura (Pies)" value={this.props.params.feet} updateValue={this.updateHeightFeet.bind(this)} />}
                                {(this.props.params.inchesToggle) &&
                                <InputFormNumberField fieldId="inches" title="Altura (pulgadas)" value={this.props.params.inches} updateValue={this.updateHeightInches.bind(this)} /> }
                                {(this.props.params.cmsToggle) &&
                                <InputFormNumberField fieldId="height" title="Altura (cm)" value={this.props.params.height} updateValue={this.updateHeight.bind(this)} />}
                                <InputFormNumberField fieldId="activityLevel" title="Nivel de Actividad (0 - 1)" value={this.props.params.activityLevel} updateValue={this.updateActivityLevel.bind(this)} />
                                <InputFormNumberField fieldId="netCarbs" title="Limite Carbohidratos Netos(g)" value={this.props.params.netCarbs} updateValue={this.updateNetCarbs.bind(this)} />

                                <InputFormNumberField fieldId="calorieAdjustment" title="Ajuste de calorias (%)" value={this.props.others.calorieAdjustment} updateValue={this.updateCalorieAdjustment.bind(this)} />
    ...
    render() {
        return (
            ...
            <div className="form-group">
                ...
                <input type="text" className="form-control" id={this.props.fieldId} value={this.toNumber(this.props.value)} onChange={this.update.bind(this)}/>
            </div>
        );
    }
}
...
<h3>Sexo:</h3>
            <div className=" form-check">
                ...
                <input className="form-check-input"
                        type="radio" name={idFemale}
                       value={core.Gender.FEMALE}
                       checked={this.props.value === core.Gender.FEMALE}
                       onChange={this.update.bind(this)}
                />
                <label className="form-check-label"or={idFemale}>Female</label>
                </div>
                 <div className=" form-check">
                <input className="form-check-input"type="radio" id={idMale}
                       value={core.Gender.MALE}
                       checked={this.props.value === core.Gender.MALE}
                       onChange={this.update.bind(this)} />
                <label className="form-check-label"for={idMale}>Male</label>
...
<button type="button" href="#"  id="kgsbutton" name={idKg} onClick={this.update.bind(this)} disabled={this.props.kilos}>Kgs</button>
<button type="button" href="#"  id="lbsbutton" name={idLb} onClick={this.update.bind(this)} disabled={this.props.libra}>Lbs</button>
...
<button type="button" href="#"  id="kgsbutton" name={idCms} onClick={this.update.bind(this)} disabled={this.props.cmsToggle}>Cms</button>
<button type="button" href="#"  id="lbsbutton" name={idInch} onClick={this.update.bind(this)} disabled={this.props.inchesToggle}>Pies/Pulgadas</button>
