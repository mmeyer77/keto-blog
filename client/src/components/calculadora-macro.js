...
if (params.lbs){
    var convertido = Math.round(params.weightlb / 2.2046);
    this.weight = getSafe(convertido, 0, 350);
}
...
if(params.inchesToggle){
    var inches =params.feet * 12;
    var cm = (inches + params.inches) / 0.39370;
    
    this.height = getSafe(cm.toFixed(2), 0, 250);
}
